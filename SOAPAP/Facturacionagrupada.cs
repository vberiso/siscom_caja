...
namespace SOAPAP
{
    class Facturacionagrupada
    {
        ...
        //public async Task<string> facturarPago(string status, string uuid, TrasactionVMA transactions, bool checks, string xmla)
        //{
        //    string respuesta = string.Empty;
        //    string rutas = string.Empty;
        //    string json = string.Empty;
        ...
        //    ////WSCFDI33.WSCFDI33Client n = new WSCFDI33.WSCFDI33Client();
        ...
        //            {
        //                //WsIntegral33Pruebas.RespuestaCancelacionV2 detalle = new WsIntegral33Pruebas.RespuestaCancelacionV2();
        //                WsIntegral33Pruebas.RespuestaCancelacion detalle = new WsIntegral33Pruebas.RespuestaCancelacion();
