...
{
    public partial class RepINAAyunt : Form
    {
        Form loading;
        ...
        private void RepINAAyunt_Load(object sender, EventArgs e)
        {
        ...
        public async Task cargar()
        {
            ...
            try
            {
                ...
                {
                    List<DataIncomeNewAccountsAyunt> lstData = JsonConvert.DeserializeObject<List<DataIncomeNewAccountsAyunt>>(_resulTransaction);
