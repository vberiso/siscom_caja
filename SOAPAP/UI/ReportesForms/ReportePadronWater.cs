...
{
    public partial class ReportePadronWater : Form
    {
        Form loading;
        ...
        public ReportePadronWater()
        {
            Requests = new RequestsAPI(UrlBase);
            InitializeComponent();
        }

        private async void ReportePadronWater_Load(object sender, EventArgs e)
        {
            loading = new Loading();
            loading.Show(this);
        ...
        public async Task cargar()
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    try
                    {
                        this.rvwReportes.LocalReport.ReportEmbeddedResource = "SOAPAP.Reportes.PadronWaterReport.rdlc";
                        this.rvwReportes.LocalReport.DataSources.Clear();

                        ReportDataSource rds1 = new ReportDataSource("PWa", lstTMP);
