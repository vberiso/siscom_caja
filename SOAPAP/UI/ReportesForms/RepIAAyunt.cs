...
{
    public partial class RepIAAyunt : Form
    {
        Form loading;
        ...
        private async void RepIAAyunt_Load(object sender, EventArgs e)
        {
            await CargarCombos();
        }
        ...
        private void btnExportar_Click(object sender, EventArgs e)
        {
            ...
            {
                string NombreFile = "IngresosAgrupados_" + Variables.LoginModel.FullName.Replace(" ", "") + "_" + DateTime.Now.ToString("yyyy-MM-dd");
