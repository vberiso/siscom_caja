...
{
    public partial class RepIOT : Form
    {
        Form loading;
        ...
        private async void RepIOT_Load(object sender, EventArgs e)
        {
            await CargarCombos();
        }
        ...
        {            
            ...
            //Elementos visibles del grid.
            pgfTotal.Visible = false;
            pgfDetalle.Visible = false;
            pgfMonto.Visible = false;
            pgfDesc.Visible = false;
            pgfSub.Visible = false;
            pgfIva.Visible = false;
            pgfTotaDt.Visible = true;
        }
        ...
        public async Task cargar()
        {
            ...
            {
                var lstData = JsonConvert.DeserializeObject<List<DataIncomeOfTreasury>>(_resulTransaction);
        ...
        private void chceMostrarDetalle_CheckedChanged(object sender, EventArgs e)
        {
            //pgfTotal.Visible = !chceMostrarDetalle.Checked;

            pgfDetalle.Visible = chceMostrarDetalle.Checked;
            pgfMonto.Visible = chceMostrarDetalle.Checked;
            pgfDesc.Visible = chceMostrarDetalle.Checked;
            pgfSub.Visible = chceMostrarDetalle.Checked;
            pgfIva.Visible = chceMostrarDetalle.Checked;
            //pgfTotaDt.Visible = chceMostrarDetalle.Checked;
        }
        ...
        private void btnExportar_Click(object sender, EventArgs e)
        {
            ...
            {
                string NombreFile = "IngresosDeTesoreria_" + Variables.LoginModel.FullName.Replace(" ", "") + "_" + DateTime.Now.ToString("yyyy-MM-dd");
                pgdIOT.ExportToXlsx(fbd.SelectedPath + "\\" + NombreFile + ".xlsx", pivotExportOptions);
